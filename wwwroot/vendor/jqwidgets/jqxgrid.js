...
(function (b) {
    ...
    b.extend(b.jqx._jqxGrid.prototype, {
        defineInstance: function () {
            ...
            if (h + f > 0) {
                while (g <= h + f) {
                    ...
                    if (g - f < h && g >= h) {
                        ...
                        if (p > 0) {
                            k -= d;
                            this._pageviews[j - 1] = {top: k, height: d - p * this.rowsheight}
                        }
                        break
                    } else {
            ...
            return {visiblerecords: q, virtualheight: l}
            ...
            b.each(this.columns.records, function (W, U) {
                ...
                x.addHandler(H, "click", function (i) {
                    ...
                    i.preventDefault();
                    x._raiseEvent(7, {column: Z.getcolumnproperties(), datafield: Z.datafield, originalEvent: i})
                });
                    ...
                    x.addHandler(H, j, function (ac) {
                        ...
                        if (x._handlecolumnsresize) {
                            if (I) {
                                ...
                                ae = 40;
                                if (i >= ah + Z.width - ae) {
                                    x.resizablecolumn = {columnelement: H, column: Z};
            ...
            if (S >= 0) {
                ...
                for (var n = 0; n < U && ab < U; n++) {
                    ...
                    if (ad != null) {
                        ...
                        this.hittestinfo[this.hittestinfo.length] = {row: ad, visualrow: k, details: false};
                        if (X && w) {
                            ab++;
                            var k = this.table[0].rows[ab];
                            this._renderrowdetails(B, k, ad, am, r, ab);
                            this.visiblerows[this.visiblerows.length] = ad;
                            this.hittestinfo[this.hittestinfo.length] = {row: ad, visualrow: k, details: true}
                        }
                        if (!this.autorowheight) {
                            if (Q + e >= x) {
                                break
            ...
            if (f.columntype == "checkbox") {
                v._rendercheckboxcell(v, d, f, k, t);
                v._cellscache[g] = {element: "", title: t};
                if (v.enabletooltips && f.enabletooltips) {
                    d.title = "" + t
                }
                return
            ...
            if (f.cellsrenderer != null) {
                ...
                if (u && (u.indexOf("<jqx-") >= 0 || u.indexOf(" ng-") >= 0)) {
                    if (v.toCompile) {
                        v.toCompile.push({cell: d, value: u, row: v.getboundindex(k)})
                    }
                    return
                }
            } else {
            ...
            v._cellscache[g] = {element: d.innerHTML, title: l};
            return true
        }, _isIE10: function () {
    ...
    b.jqx.dataview = function () {
        ...
        this.databind = function (w, n) {
            ...
            if (v) {
                ...
                h = new b.jqx.dataAdapter(w, {autoBind: false})
            }
            var f = function (m) {
                h.recordids = [];
                h.records = new Array();
            ...
            var A = function (H) {
                ...
                if (!H.virtualmode) {
                    ...
                    var o = {startindex: H.pagenum * H.pagesize, endindex: (H.pagenum * H.pagesize + H.pagesize)};
                    ...
                    if (!w.recordendindex) {
                        if (!H.grid.pageable) {
                            ...
                            o = {startindex: H.pagenum * H.pagesize, endindex: (H.pagenum * H.pagesize + H.pagesize)}
                        }
                    }
                    o.data = h.records;
        ...
        this.refresh = function (k) {
                ...
                if (this.source != null && this.source.filter != undefined && this.source.localdata != undefined) {
                    ...
                    if (this.source.filter == null || this.source.filter == undefined) {
                        for (var i = 0; i < e; i++) {
                            ...
                            if (r) {
                                h[h.length] = b.extend({dataindex: i}, g);
                                this._dataIndexToBoundIndex[i] = {boundindex: h.length - 1}
                            } else {
            ...
            if (this.rowschangecallback != null) {
                ...
                if (f != rows.length) {
                    this.rowschangecallback({type: "RowsCountChanged", data: {previous: f, current: rows.length}})
                }
                if (n.length > 0 || f != rows.length) {
                    this.rowschangecallback({type: "RowsChanged", data: {previous: f, current: rows.length, diff: n}})
                }
            }
        };
        return this
