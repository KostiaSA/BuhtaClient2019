    ...
    b.jqx.dataView = function () {
        ...
        this.databind = function (w, n) {
            ...
            if (v) {
                ...
                g = new b.jqx.dataAdapter(w, {autoBind: false})
            }
            var e = function (m) {
                g.recordids = [];
                g.records = new Array();
                ...
                if (w.type != undefined) {
                    g._options.type = w.type
                }
                if (w.formatdata != undefined) {
                    g._options.formatData = w.formatdata
                }
                if (w.contenttype != undefined) {
                    g._options.contentType = w.contenttype
                }
                if (w.async != undefined) {
                    g._options.async = w.async
                }
                if (w.updaterow != undefined) {
                    g._options.updaterow = w.updaterow
                }
                if (w.addrow != undefined) {
                    g._options.addrow = w.addrow
                }
                if (w.deleterow != undefined) {
                    g._options.deleterow = w.deleterow
                }
                if (m.pagesize == 0) {
                    m.pagesize = 10
                }
            ...
            switch (w.datatype) {
                ...
                default:
                    ...
                    if (w.localdata != null) {
                        ...
                        l();
                        g.bindBindingUpdate(h.grid.element.id, l)
                    }
                    break;
                case"json":
                case"jsonp":
                ...
                case"tab":
                    ...
                    for (var j = 0; j < this.filters.length; j++) {
                        ...
                        var i = k.getfilters();
                        D[f + "operator"] = k.operator;
                        for (var z = 0; z < i.length; z++) {
                            i[z].datafield = f;
                            var t = i[z].value;
                            if (i[z].type == "datefilter") {
                                if (i[z].value && i[z].value.toLocaleString) {
                                    var c = this.grid.getColumn(i[z].datafield);
                                    if (c && c.cellsformat) {
                                        var y = this.grid.source.formatDate(i[z].value, c.cellsformat, this.grid.gridlocalization);
                                        if (y) {
                                            D["filtervalue" + u] = y
                                        } else {
                    ...
                    var E = g._options.data;
                    if (g._options.data) {
                        b.extend(g._options.data, D)
                    } else {
                        if (w.data) {
                            b.extend(D, w.data)
                        }
                    ...
                    g.bindDownloadComplete(h.grid.element.id, l);
