        ...
        defineInstance: function () {
            ...
            if (this.rtl) {
                if (this.scrollable && this._rightArrow && a(this._rightArrow).css("visibility") !== "hidden") {
                    ...
                    var c = this._width(this.element) - parseInt(this._width(this._unorderedList) + d + parseInt(this._unorderedListHelper.css("margin-left"), 10), 10);
                    this._unorderedList.style.left = c + "px"
                }
            }
        }, _refresh: function () {
            ...
            while (c) {
                c--;
                var d = this._titleList[c], b = "jqx-tabs-title jqx-item";
                d.style.padding = "";
            ...
            var f = parseInt(this._width(this._unorderedList) + parseInt(this._unorderedListHelper.css("margin-left"), 10), 10),
                h = this._width(this.element), g, i, b = parseInt(this._unorderedListHelper.css("left"), 10),
                c = this._getArrowsDisplacement(), d = 0, j;
            if (this.scrollable) {
            ...
            this._stop(this._unorderedListHelper);
            this._unlockAnimation("unorderedList");
            var b = parseInt(this._unorderedListHelper.css("left"), 10), c = this._getArrowsDisplacement(), e = 0, d;
            ...
            this._unorderedListHelper.animate({left: e}, c, function () {
            ...
            while (d) {
                d--;
                var b = this._titleList[d], g = this._outerWidth(b, true), f = parseInt(a(b).offset().left, 10), e = f;
            ...
            if (d === -1 || !f) {
                ...
                this._raiseEvent(10, {item: b, dropIndex: d});
            ...
            var e = this._titleList[this.selectedItem], d = this._titleList[b];
            ...
            var c = this.getZoomFactor(), b = -parseInt(this._unorderedListHelper.css("left"), 10);
            ...
            var c = this, e = a(c._headerWrapper);
            ...
            var b = this._selectedItem, c = this;
            ...
            while (h) {
                h--;
                var j = this._titleList[h], b = g._closeButtonList[h];
            ...
            while (j) {
                j--;
                var n = this._titleList[j], p = a(n), b = p.children()[0], m = this._closeButtonList[j],
                    k = parseInt(p.css("padding-top"), 10);
                if (!k) {
                    k = 0
                }
                if (this.autoHeight) {
                    var c = parseInt(p.css("padding-top"), 10), o = parseInt(p.css("padding-bottom"), 10),
                        i = p.css("border-top-width"), f = p.css("border-bottom-width");
                    if (i.indexOf("px") === -1) {
                        i = 1
                    } else {
                        i = parseInt(i, 10)
            ...
            if (e) {
                ...
                b = this.element.offsetHeight - this._headerWrapper.offsetHeight;
                ...
                if (this.height !== "auto") {
                    ...
                    // this._contentWrapper.style.height = "auto" -- убрано buhta

                    // добавлено buhta  BEGIN
                    this._contentWrapper.style.height=0;
                    setTimeout(()=>{
                        d.element.style.height = d._toPx(d.height);
                        b = this._height(d.element) - this._headerWrapper.offsetHeight;
                        this._contentWrapper.style.height = d._toPx(b)
            ...
            var d = document.createElement("div"), g = this._titleList[c];
            ...
            if (!this.selectionTracker || (g !== undefined && g)) {
                ...
                if (d >= 0 && f !== undefined) {
                    ...
                    var b = "jqx-fill-state-hover", e = " jqx-fill-state-pressed";
                    if (this.position === "top") {
            ...
            if (!this._tabCaptured) {
                ...
                var k = a(g._titleList[h]), d = g._titleList[h].getAttribute("id"), j = a(g._contentList[h]);
            ...
            if (d >= 0) {
                if (!this._tabCaptured) {
                    var g = this, e = g._contentList[d], c = a(e), h = g._titleList[d], f = a(h);
            ...
            if (this._isValidIndex(b) && (this.canCloseAllTabs || this.length() > 1)) {
                ...
                var d = this, c = d._outerWidth(this._titleList[b], true), g = this.getTitleAt(b);
                ...
                this._removeEventHandlers();
                this._addEventHandlers();
                this._raiseEvent(3, {item: b, title: g});
                this._isAnimated = {};
                var f;
                ...
                if (d._width(this._unorderedList) <= d._width(this._headerWrapper)) {
                    ...
                    this._lockAnimation("unorderedList");
                    this._unorderedListHelper.animate({left: 0}, e, function () {
            ...
            this._lockAnimation("unorderedList");
            this._unorderedListHelper.animate({left: h}, this.scrollAnimationDuration, function () {
                d._unlockAnimation("unorderedList");
            ...
            var b = a(e), g = b.css("border-left-width"), c = b.css("border-right-width"),
                d = parseInt(b.css("padding-left"), 10), h = parseInt(b.css("padding-right"), 10);
            if (g.indexOf("px") === -1) {
                g = 1
            } else {
                g = parseInt(g, 10)
            ...
            var f = c.offsetWidth;
            if (g) {
                var b = a(c), d = parseInt(b.css("margin-left"), 10), e = parseInt(b.css("margin-right"), 10);
                f += d + e
            }
            return f
        }, _height: function (e) {
            var c = a(e), h = c.css("border-top-width"), d = c.css("border-bottom-width"),
                f = parseInt(c.css("padding-top"), 10), g = parseInt(c.css("padding-bottom"), 10);
            if (h.indexOf("px") === -1) {
                h = 1
            } else {
                h = parseInt(h, 10)
            ...
            if (g) {
                var b = a(e), c = parseInt(b.css("margin-top"), 10), d = parseInt(b.css("margin-bottom"), 10);
                f += c + d
            }
            return f
        }, _stop: function (b) {
